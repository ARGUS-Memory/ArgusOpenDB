...
**Standard breathable atmosphere:** 21% oxygen, 79% nitrogen at 101.325 kPa (one atmosphere) and ~20°C (293.15 K). This composition sustains respiration and does not support spontaneous combustion.
...
**Volume reference:** Standard atmospheric cells hold 2,500 liters. At standard conditions this corresponds to ~102 moles of gas per cell (~21.5 moles O2 and ~81 moles N2).
...
**Combustion ratio:** Phoron fires consume ~3 moles of oxidizer per 2 moles of fuel. Fires sustain until one reactant is exhausted or temperature drops below ignition threshold.
...
| Fragment threshold | 50 atm (5,066 kPa) | Canister explodes, ~4.5-metre blast radius |
