...
The station's primary power source: a supermatter crystal energized by an emitter and kept stable by a circulating [phoron](../../History/Setting/PhoronAndBluespace.md) coolant loop.
