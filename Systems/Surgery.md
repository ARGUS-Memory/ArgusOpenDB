...
| Tool | Primary use |
|---|---|
| Scalpel | Creating incisions; detaching organs |
| Hemostat | Clamping bleeders; extracting tissue |
| Retractor | Retracting flesh to expose the interior |
| Cautery | Sealing incisions |
| Circular saw | Amputation; bone cutting |
| Bone gel | Bonding and finishing fracture repairs |
| Bone setter | Setting displaced bones |
| Surgical drill | Creating cavities; vertebral drilling |
| Bone clamp | Single-step fracture repair |
| FixOVein | Repairing blood vessels and internal bleeding |
| Bioregen | Restoring tissue; detoxification |
| Nanopaste | Repairing robotic organs and components |

Laser scalpels substitute for the standard scalpel and produce bloodless incisions. An incision manager performs the incision and retraction in a single step.
