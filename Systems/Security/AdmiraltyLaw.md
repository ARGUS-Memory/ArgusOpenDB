...
| | |
|---|---|
| [Origin and Scope](#origin-and-scope) | History, jurisdiction, Earth-derived basis |
...
If a suspect is captured on admiralty charges, they are held in custody pending trial. Because small installations such as the NCS Northern Star are not equipped for long-term prisoner holding pending galactic trial, the USDF should be contacted to arrange prisoner transfer to a properly equipped facility as soon as practicable.

Admiralty charges are rarely applicable to ordinary crew operating under standard station conditions. Situations in which admiralty law becomes relevant typically involve event roles or characters participating in designated antagonist scenarios such as piracy operations.
