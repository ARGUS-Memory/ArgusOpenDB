[ARGUS Station Database](../../README.md) > [Systems](../README.md) > [Security](README.md) > Weapons

# Weapons

Reference for melee and ranged weapons available to security personnel and the general crew population. Energy weapons, ballistic weapons, and ammunition are covered here. For armor and restraint equipment, see [Armor and Equipment](Armor.md).
...
| Weapon | Capacity | Caliber | Notes |
|---|---|---|---|
| Pump Shotgun | 5 (4+1) | 12g | Pump action between shots; default non-lethal beanbag load |
| Combat Shotgun | 8 (7+1) | 12g | Higher capacity; slug or standard loads |
| Double-Barrel | 2 | 12g | Single or both barrels; zero burst delay for both-barrel shot |
| Sawn-Off | 2 | 12g | Compact (fits on belt); reduced force |
| Semi-Auto Shotgun | 5 | 12g | No pump required; default beanbag load |

### Rifles and Long Arms

| Weapon | Caliber | Capacity | Accuracy Notes |
|---|---|---|---|
| Sniper Rifle (SVD variant) | 7.62mm | Magazine-fed | -45 accuracy hip-fire; 0 scoped |
| Anti-Materiel Rifle | 14.5mm | 1 | -75 accuracy without scope, +75 scoped; recoil 5; extreme armor penetration rounds |
...
### Ballistic Projectile Types

| Type | Caliber | Damage | Armor Pen | Special |
|---|---|---|---|---|
| Standard | 9mm | 20 brute | 0% | -- |
| AP | 9mm | 15 brute | 30% | Reduced damage trades for penetration |
| Hollow Point | 9mm | 25 brute | -50% | Higher damage vs unarmored; blocked by armor |
| Standard | .45 | 25 brute | 0% | -- |
| AP | .45 | 20 brute | 15% | -- |
| Hollow Point | .45 | 30 brute | -50% | -- |
| Rubber | .45 | 5 brute | -- | 40 agony; non-lethal |
| High-Power | .357/.44 | 60 brute | 0% | -- |
| Rubber (high-power) | .357/.44 | 10 brute | -- | 60 agony |
| Stun | .357/.44 | 10 brute | -- | 100 agony; incapacitating |
| AP (14.5mm) | 14.5mm | Very high | High | Anti-materiel; penetrates most armor |
| Beanbag | 12g | Non-lethal | -- | Impact stun; standard shotgun non-lethal load |
| Buckshot | 12g | High multi | 0% | Multi-projectile spread |
| Slug | 12g | High single | Variable | Single high-damage projectile |

### Energy Projectile Types

| Type | Damage | Effect |
|---|---|---|
| Standard electrode | 0 | 40 agony; taser effect; brief electrical stun |
| Strong electrode | 0 | 55 agony |
| Stunshot electrode | 5 | 80 agony; incapacitation |
| Energy flash | 5 | Flash/blindness; 7 brightness; confuses |
| Midlaser beam | Burn | Standard laser rifle damage class |
| Weak laser | Burn | Reduced; suppressive fire |

---

*See also: [Armor and Equipment](Armor.md), [Security Operations](SecurityOperations.md), [Contraband](Contraband.md)*
