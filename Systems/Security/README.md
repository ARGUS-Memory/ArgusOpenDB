[ARGUS Station Database](../../README.md) > [Systems](../README.md) > Security

# Systems: Security

| Document | Summary |
|---|---|
| [Corporate Regulations](CorporateRegulations.md) | Legal code, offense tiers, sentencing guidelines, and tribunal procedure |
| [Law Reference](LawReference.md) | Full per-offense descriptions, enforcement notes, and sentence modifier table |
